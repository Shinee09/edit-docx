...
$nameC = $_POST["ctyc-efytdtt"];

$nameM = $_POST["ctym-efytdtt"];
$addressM = $_POST["dcm-efytdtt"];
...
try
{
    ...
    if($zip->open($full_path) == true)
    {
        ...
        $message = str_replace("tokenmcty", $nameM,   $message);
        $message = str_replace("tokenmdc", $addressM,   $message);
