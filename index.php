                        ...
                        <div class="tab-pane show active" id="vinca" role="tabpanel" aria-labelledby="tab-css">
                            <div class="container-fluid supplier-content">
                                ...
                                <div class="supplier-block">
                                    ...
                                    <form name="form" id="form-vinca" method="post" onsubmit="handleSubmitForm(this)">
                                        <div class="row">
                                            <div class="form-group col-lg-6">
                                                <label for="company-taxcode">Mã số thuế <span
                                                        class="input-important"></span></label>
                                                <input name="company-taxcode" class="form-control company-taxcode"
                                                    maxlength="14" minlength="10" pattern="[-+]?[0-9]*[-]?[0-9]+"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input type="text" name="company-position"
                                                    class="form-control company-position" value="Giám đốc" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="btn-download-block">
                                            <button type="submit" name="create_word" class="btn btn-info btn-download"
                                                formaction="./file/vinca-gdk.php">
                            ...
                            <div class="container-fluid supplier-content">
                                ...
                                <div class="supplier-block">
                                    ...
                                    <form name="form" id="form-vina" method="post">
                                        ...
                                        <button class="btn btn-outline-success dropdown-toggle btn-sm btn-more-agency"
                                            ...
                                            <div>
                                                <div class="form-group">
                                                    <select name="select-vina-c" onchange="handleChangeAgency(this)"
                                                        ...
                                                        <option value="1" selected>CÔNG TY TNHH KỸ THUẬT CHỮ KÝ SỐ VIỆT
                                                            NAM</option>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-lg-6">
                                                        ...
                                                        <input name="company-taxcode-c" id="company-taxcode-c"
                                                            class="form-control" value="0309612872" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="company-name-c" id="company-name-c"
                                                        class="form-control"
                                                        value="CÔNG TY TNHH KỸ THUẬT CHỮ KÝ SỐ VIỆT NAM" required="">
                                                </div>
                                                <div class="form-group">
                                                    <label for="company-address-c">Địa chỉ <span
                                                            class="input-important"></span></label>
                                                    <input type="text" name="company-address-c" id="company-address-c"
                                                        class="form-control"
                                                        value="41A Nguyễn Phi Khanh, Phường Tân Định, Quận 1, Thành phố Hồ Chí Minh"
                                                        required="">
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-lg-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-lg-4">
                                                        ...
                                                        <div class="date-block">
                                                            <input data-maxlength="2" min="1" max="31" name="day-c"
                                                                class="form-control text-center" id="day-c" required=""
                                                                value="08" />
                                                            <span class="space-date"></span>
                                                            <input data-maxlength="2" min="1" max="12" name="month-c"
                                                                class="form-control text-center" id="month-c"
                                                                required="" value="02" />
                                                            <span class="space-date"></span>
                                                    ...
                                                    <div class="form-group col-lg-4">
                                                        ...
                                                        <br />
                                                        <input type="text" name="director-c-issued" class="form-control"
                                                            id="director-c-issued" required=""
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-lg-4">
                                                        ...
                                                        <input type="text" name="bank-name" id="bank-name"
                                                            class="form-control" value="VPBank chi nhánh Cộng Hoà" />

                                                    </div>
                                                    <div class="form-group col-lg-4">
                                                        <label>Tên:</label>
                                                        <input type="text" name="bank-beneficiary" id="bank-beneficiary"
                                                            class="form-control"
                                            ...
                                            <div class="form-group col-lg-6">
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input checked-contract"
                                                        onclick="handleCheckedContractFpt()" id="checked-contract-fpt"
                                                        checked>
                                                ...
                                                <div>
                                                    <div class="form-row date-block">
                                                        ...
                                                        <input type="number" data-maxlength="2" min="1" max="12"
                                                            name="month" class="form-control text-center" id="month-fpt"
                                                            value=<?php echo date('m') ?> />
                                                        <span class="space-date"></span>
                                                        <input type="number" data-maxlength="4" min="1900" max="2100"
                                                            name="year" class="form-control text-center" id="year-fpt"
                                            ...
                                            <div class="form-group col-lg-6">
                                                <div class="form-check form-switch">
                                                    <input type="checkbox"
                                                        ...
                                                        onclick="handleCheckedContractEasy()" id="checked-contract-easy"
                                                        checked>
                                                ...
                                                <div>
                                                    <div class="form-row date-block">
                                                        <input type="number" data-maxlength="2" min="1" max="31"
                                                            name="day" class="form-control text-center" id="day-easy"
                                                            value=<?php echo date('d') ?> />
                                                        <span class="space-date"></span>
                                                        <input type="number" data-maxlength="2" min="1" max="12"
                                                        ...
                                                        <span class="space-date"></span>
                                                        <input type="number" data-maxlength="4" min="1900" max="2100"
                                                            name="year" class="form-control text-center" id="year-easy"
                                                            value=<?php echo date('Y') ?> />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-lg-4">
                                                ...
                                                <div class="date-block">
                                                    <input data-maxlength="2" min="1" max="31" name="day-issued"
                                                        class="form-control text-center" id="day-issued" required="" />
                                                    <span class="space-date"></span>
                                                    <input data-maxlength="2" min="1" max="12" name="month-issued"
                                                        class="form-control text-center" id="month-issued"
                                                        required="" />
                                                    <span class="space-date"></span>
                                                    <input data-maxlength="4" min="1900" max="2100" name="year-issued"
                                                        class="form-control text-center" id="year-issued" required="" />
                                                </div>
                                                <script>
                                                $(document).ready(function() {
                                ...
                                <div class="supplier-block">
                                    ...
                                    <form name="form" id="form-ca2" method="post">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-lg-6">
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input checked-contract-ca2"
                                                        onclick="handleCheckedContractCa2()" id="checked-contract-ca2"
                                                        checked>
                                                ...
                                                <div>
                                                    <div class="form-row date-block">
                                                        ...
                                                        <span class="space-date"></span>
                                                        <input type="number" data-maxlength="2" min="1" max="12"
                                                            name="month" class="form-control text-center" id="month-ca2"
                                                            value=<?php echo date('m') ?> />
                                                        <span class="space-date"></span>
                                                        <input type="number" data-maxlength="4" min="1900" max="2100"
                                                            name="year" class="form-control text-center" id="year-ca2"
                                                            value=<?php echo date('Y') ?> />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="btn-download-block">
                                            <button type="submit" name="create_word" class="btn btn-info btn-download"
                                                id="btn-ca2-hd" formaction="./file/ca2-hd.php">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                    fill="currentColor" class="bi bi-file-earmark-word-fill"
                                                    viewBox="0 0 16 16">
                                                    <path
                                        ...
                                        <div class="btn-download-block">
                                            <button type="submit" name="create_word" class="btn btn-info btn-download"
                                                id="btn-ca2-cm" formaction="./file/ca2-cm.php" disabled="disabled">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                    fill="currentColor" class="bi bi-file-earmark-word-fill"
                                                    viewBox="0 0 16 16">
                                                    <path
                                            ...
                                            <button type="submit" name="create_word" class="btn btn-info btn-download"
                                                id="btn-ca2-gh" formaction="./file/ca2-gh.php" disabled="disabled">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                    fill="currentColor" class="bi bi-file-earmark-word-fill"
                                                    viewBox="0 0 16 16">
                                                    <path
